---
title: "Descrição do Banco de Dados"
...
Neste documento, torna-se disponível a descrição das variáveis contidas no banco de dados utilizado no artigo. 

## Banco de Dados

- `cod_munic` = Codigo Municipal IBGE

- `ano` = Ano da eleição local (ciclo de quatro anos a seguir para adoção do Orçamento participativo)
...
- `esq` = proporção de votos dos campos não majortários do PT no PED (Dados cedidos pela SORG-PT).